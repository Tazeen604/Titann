...
if (!empty($_POST)) {
    ...
    if ($form) {
        ...
        $articleviews=0;
        $result      = $crud->insertpost($articlename, $articlecont, $imgname,$articleviews);
...
<form  class="form-horizontal m-5 p-5 align-center" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
<fieldset>
